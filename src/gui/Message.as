...
public class Message extends Sprite {
	 ...
	 */
	public function Message(text:String, colorBg:uint = 0x00FF00, alphaBg:Number = 1, time:Number = 4, sizeFont:int = 32,
							isBold:Boolean = true, font:String = "Tahoma", width:int = 0, height:int = 0,
							sizeRound:int = 45) {
		this.time = time;
