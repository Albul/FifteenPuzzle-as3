...
public class StyledText extends TextField {
	...
	public static function Create(text:String, sizeFont:int, style:Object):StyledText {
		return new StyledText(text, (sizeFont != 0? sizeFont : style.sizeFont), style.font, style.colorText,
				style[Style.IS_MULTILINE], style.colorBorder, style.mouseEnabled);
	}

	public function StyledText(text:String = null, sizeFont:int = 14, font:String = "Comic Sans MS",
							   colorText:uint = 0xDBF224, isMultiline:Boolean = false, colorBorder:uint = 0x000000,
