...
public class AboutState extends BaseState {
	...
	public function AboutState(container:Sprite) {
		...
		lAbout.text = "<br> Игра создана и выложена на Github для обучения <br>"
				...
				+ " Специально для сайта <a href='event:http://gamecook.org'><strong>gamecook.org</strong></a>"
		lAbout.x = 40;
		...
		var lSite:StyledText = StyledText.Create("Сайт: http://gamecook.org", 20, Styles.ORANGE_TEXT_LINK);
